...
public class IngredientReaderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvFeatureTitle.setText(R.string.ingredient_reader);

        // Initialize Text-to-Speech
        textToSpeech = new TextToSpeech(this, status -> {
            if (status == TextToSpeech.SUCCESS) {
                textToSpeech.setLanguage(new Locale("vi", "VN"));
                speak(getString(R.string.ingredient_reader) + ". " + getString(R.string.tap_to_capture));
            }
        });
        ...
        imageCapture.takePicture(ContextCompat.getMainExecutor(this),
                new ImageCapture.OnImageCapturedCallback() {
                    ...
                    public void onError(@NonNull ImageCaptureException exception) {
                        Toast.makeText(IngredientReaderActivity.this,
    ...
    private void processImage(ImageProxy imageProxy) {
        ...
        textRecognizer.process(image)
                .addOnSuccessListener(visionText -> {
                    ...
                    if (text.isEmpty()) {
                        text = "Không tìm thấy thành phần nào";
                    } else {
